...
describe('Hexo Symbols Count Time', function() {
  ...
  describe('Test symbolsCount < 999', function() {
    var symbols = helper.symbolsCount('Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.');

    it('Symbols: 569 => 569', function() {
      assert.equal(symbols, '569');
    });
  });
  ...
  describe('Test symbolsCount > 999', function() {
    ...
    it('Symbols: 1337 => 1.3k', function() {
      assert.equal(symbols, '1.3k');
    });
  });

  describe('Test symbolsCount > 9999', function() {
    var symbols = helper.symbolsCount(elevenThousandsSymbols);

    it('Symbols: 10703 => 11k', function() {
      assert.equal(symbols, '11k');
    });
  });

  describe('Test symbolsCount & symbolsTime (awl / wpm)', function() {
    ...
    it('Symbols: (symbolsCount = 90)', function() {
      var symbols = helper.symbolsCount(post.content);
      assert.equal(symbols, 90);
    });

    it('Time: [awl = 5, wpm = 200] => 1 mins.', function() {
      var symbols = helper.symbolsTime(post.content);
      assert.equal(symbols, '1 mins.');
    });

    it('Time: [awl = 5, wpm = 5] => 4 mins.', function() {
      var symbols = helper.symbolsTime(post.content, 5, 5);
      assert.equal(symbols, '4 mins.');
    });

    it('Time: [awl = 1, wpm = 50] => 2 mins.', function() {
      var symbols = helper.symbolsTime(post.content, 1, 50);
      assert.equal(symbols, '2 mins.');
    });
